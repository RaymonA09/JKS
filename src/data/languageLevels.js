export const languageLevels = [
  ...
  },
  {
    ...
    guidelines: {
      format: "Blended Learning",
      schedule: "2 days online + 3 days offline with tasks",
      hours: "Total 120 hours (60 online + 60 offline)",
    ...
    schedule: [
      ...
      { day: "Tuesday", time: "Self-paced", format: "Offline - Advanced Tasks" },
      { day: "Wednesday", time: "18:00 - 20:00", format: "Online - Live Session" },
      { day: "Thursday", time: "Self-paced", format: "Offline - Research Projects" },
      { day: "Friday", time: "Self-paced", format: "Offline - Practice & Review" }
    ],
    topics: ["Academic German", "Professional Presentations", "Complex Negotiations", "Literary Analysis", "Advanced Grammar"]
  },
  {
    level: "C2",
    ...
    schedule: [
      { day: "Monday", time: "18:00 - 20:00", format: "Online - Live Session" },
      { day: "Tuesday", time: "Self-paced", format: "Offline - Expert-Level Tasks" },
      { day: "Wednesday", time: "18:00 - 20:00", format: "Online - Live Session" },
      { day: "Thursday", time: "Self-paced", format: "Offline - Advanced Projects" },
      { day: "Friday", time: "Self-paced", format: "Offline - Practice & Review" }
    ],
    topics: ["Idiomatic Expressions", "Cultural Nuances", "Professional Writing", "Public Speaking", "Translation Skills"]
  }
];